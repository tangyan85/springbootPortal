...
@Component
public class MyFilterSecutiryInterceptor extends AbstractSecurityInterceptor implements Filter {
    @Autowired
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        User userDetails = (User) ((HttpServletRequest) servletRequest).getSession().getAttribute("user");
        if (userDetails != null) {
